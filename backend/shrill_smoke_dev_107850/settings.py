"""
Django settings for shrill_smoke_dev_107850 project.
...
ROOT_URLCONF = 'shrill_smoke_dev_107850.urls'
...
WSGI_APPLICATION = 'shrill_smoke_dev_107850.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "shrill_smoke_dev_107850 API",
    "DESCRIPTION": "API documentation for shrill_smoke_dev_107850 App",
    "VERSION": "v1",
}
